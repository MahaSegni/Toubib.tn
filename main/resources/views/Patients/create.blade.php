                    ...
                    <form method="post" action="{{ route('patient.store') }}">
                        @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="age" type="number" class="form-control @error('age') is-invalid @enderror" name="age"  autocomplete="age">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="poids" type="number" step="0.01" min="0" class="form-control @error('poids') is-invalid @enderror" name="poids"  autocomplete="poids">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="taille" type="number"  step="0.01" min="0"  class="form-control @error('taille') is-invalid @enderror" name="taille"  autocomplete="taille">
